...
(function ($) {
    CarouselSlider = function (element, options) {
        ...
        var createPrevNextButtons = function () {
                ...
                el.children('.nextButton').bind('mouseover', runAutoplay);
                el.children('.nextButton').bind('mouseout', function(){clearInterval(intervalProcess);return;});
                el.children('.prevButton').bind('click', prevClick);
                el.children('.prevButton').bind('mouseover', runAutoplayback);
                el.children('.prevButton').bind('mouseout', function(){clearInterval(intervalProcess);return;});
            };
